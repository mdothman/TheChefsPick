...
export default function Search() {
  ...
  const handleIngredientsSubmit = (event) => {
    ...
    console.log(ingredients);
    let url = `https://api.spoonacular.com/recipes/findByIngredients?ingredients=${ingredients.ingredient1},+${ingredients.ingredient2},+${ingredients.ingredient3}&number=1&rank=1&apiKey=${API_KEY}`;
